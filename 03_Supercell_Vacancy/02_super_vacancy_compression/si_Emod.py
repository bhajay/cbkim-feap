...
# CAUTION: Area is now set as 1x1 unit^2. 
A=1; # Area with normal in 33 direction
...
fig.suptitle('Supercell Stress Strain Curve (Atom 14 Vacancy)')
fig.savefig('figures/SS_Supercell_Vacancy_Atom15.png', dpi=100)
fig.show()
